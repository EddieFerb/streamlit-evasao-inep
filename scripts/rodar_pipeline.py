...
if __name__ == "__main__":
    ...
    print("2 - feature-based.py (demora 1–2 horas) / (takes 1–2 hours)")
    ...
    if escolha == "1":
        ...
        print("\n⚠️ Atenção / Warning:")
        print("O script feature-based.py pode levar entre 1 a 2 horas para rodar. / The script feature-based.py may take between 1 and 2 hours to run.")
        ...
        if confirm in ["s", "y"]:
            run("python scripts/modelagem/feature-based.py")
        else:
